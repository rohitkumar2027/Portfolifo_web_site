...
?> 
         <form action="php/uexpriance.php" method="post">
                 <div class="form-row">    
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="title" class="form-control" id="website" placeholder="Working at Hedkey India Pvt. Ltd. , New Delhi" required>
  </div>
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
    <input type="text" name="year" class="form-control" id="website" placeholder="2018-2019" >
  </div>
...
while($data2=mysqli_fetch_array($queryrun2)){
  ...
  <div class="modal-dialog">
   ...
   <div class="form-group col-md-8">
    <label for="website">Institute or Company Name</label>
    <input type="text" name="title" value="<?=$data2['Title']?>" class="form-control" id="website" placeholder="Working at Hedkey India Pvt. Ltd. , New Delhi" required>
  </div>
   <div class="form-group col-md-4">
    <label for="website">Duration or Time Period</label>
    <input type="text" name="year" value="<?=$data2['year']?>" class="form-control" id="website" placeholder="2018-2019" >
  </div>
  <div class="form-group col-md-12">
    <label for="exampleFormControlTextarea1">Description (leave blank if you dont want to)</label>
    <textarea class="form-control" name="workdesc" id="exampleFormControlTextarea1" rows="3" placeholder="I am ambitious and driven.
      and I'm always looking for an opportunity to do better and achieve greatness. In my previous role, I was promoted three times
       in less than two years."><?=$data2['workdec']?></textarea>
  </div>
  ...
  Edit
</button> <a href="php/uexpriance.php?del=<?=$data2['id']?>"><button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
  Delete
             </button></a></td>
            </tr>            
         <?php $count++;
